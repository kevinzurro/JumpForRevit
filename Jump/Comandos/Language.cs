...
namespace Jump
{
    public class Language
    {
        ...
        private static void CargarEspanol()
        {
            ...
            Espanol.Add("Zap1-2-2", "Elementos seleccionados");
            Espanol.Add("Zap1-2-3", "Elementos de la lista");
            Espanol.Add("Zap1-3", "Orden");
            Espanol.Add("Zap1-4", "Enumeración");
            Espanol.Add("Zap1-4-1", "Prefijo");
            Espanol.Add("Zap1-4-2", "Número inicial");
            Espanol.Add("Zap1-4-3", "Incremento");
            Espanol.Add("Zap1-4-4", "Sufijo");
            Espanol.Add("Zap1-4-5", "Vista previa");
            Espanol.Add("Zap1-4-6", "Parámetro");
            Espanol.Add("Zap1-4-7", "Enumeración");
            Espanol.Add("Zap2-1", "Etiquetas");
            Espanol.Add("Zap2-2", "Etiquetas y cotas");
            Espanol.Add("Zap2-2-1", "Escala");
            Espanol.Add("Zap2-2-2", "Etiqueta de cimentación");
            Espanol.Add("Zap2-2-3", "Etiqueta de armadura");
            Espanol.Add("Zap2-2-4", "Longitud parcial de la barra");
            ...
            Espanol.Add("Zap4-2-2", "Vista X-X");
            Espanol.Add("Zap4-2-3", "Vista Y-Y");
            Espanol.Add("Zap4-3", "Vista previa");
