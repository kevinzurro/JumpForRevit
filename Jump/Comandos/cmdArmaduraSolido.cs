...
namespace Jump
{
    ...
    public class cmdArmaduraSolido : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            using (Transaction t = new Transaction(doc, Language.ObtenerTexto(IdiomaDelPrograma, "VisArmSol")))
            {
                t.Start();
                ...
                try
                {
                    vistaActual.DetailLevel = ViewDetailLevel.Fine;
                }
                catch (Exception) { }
